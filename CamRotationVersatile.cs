...
public class CamRotationVersatile : MonoBehaviour
{
    ...
    void Start()
    {
        ...
        Debug.Log(logFileName + " P2P_Amp_calc = " + P2P_Amp_calc + " Degrees");
        ...
        string spec = P2P_Amp.ToString() + "deg" + Vel_max.ToString() + "dps"; 
        dataLogger = new StreamWriter(logPath + "/VR_" + logFileName + '_' + spec + '_' + timeString + ".txt");
        timeLog = new StreamWriter(logPath + "/Time_" + logFileName + '_' + spec + '_' + timeString + ".txt");
        daqSignal = new StreamWriter(logPath + "/daq_" + logFileName + '_' + spec + '_' + timeString + ".txt");
        headMotionLog = new StreamWriter(logPath + "/HeadMotion_" + logFileName + '_' + spec + '_' + timeString + ".txt");
    }
